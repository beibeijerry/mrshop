...
public class AdminGoodsOrder extends AppGoodsOrder implements Serializable{
  ...
  public boolean equals(Object o) {
    ...
    AdminGoodsOrder adminGoodsOrder = (AdminGoodsOrder) o;
    return (orderNo == null ? adminGoodsOrder.orderNo == null : orderNo.equals(adminGoodsOrder.orderNo)) &&
        (goodsNo == null ? adminGoodsOrder.goodsNo == null : goodsNo.equals(adminGoodsOrder.goodsNo)) &&
        (goodsThumb == null ? adminGoodsOrder.goodsThumb == null : goodsThumb.equals(adminGoodsOrder.goodsThumb)) &&
        (goodsTitle == null ? adminGoodsOrder.goodsTitle == null : goodsTitle.equals(adminGoodsOrder.goodsTitle)) &&
        (goodsDetail == null ? adminGoodsOrder.goodsDetail == null : goodsDetail.equals(adminGoodsOrder.goodsDetail)) &&
        (count == null ? adminGoodsOrder.count == null : count.equals(adminGoodsOrder.count)) &&
        (goodsTotalPrice == null ? adminGoodsOrder.goodsTotalPrice == null : goodsTotalPrice.equals(adminGoodsOrder.goodsTotalPrice)) &&
        (postage == null ? adminGoodsOrder.postage == null : postage.equals(adminGoodsOrder.postage)) &&
        (status == null ? adminGoodsOrder.status == null : status.equals(adminGoodsOrder.status)) &&
        (statusDes == null ? adminGoodsOrder.statusDes == null : statusDes.equals(adminGoodsOrder.statusDes)) &&
        (createTime == null ? adminGoodsOrder.createTime == null : createTime.equals(adminGoodsOrder.createTime)) &&
        (logisticsName == null ? adminGoodsOrder.logisticsName == null : logisticsName.equals(adminGoodsOrder.logisticsName)) &&
        (logisticsNo == null ? adminGoodsOrder.logisticsNo == null : logisticsNo.equals(adminGoodsOrder.logisticsNo)) &&
        (shippingAddress == null ? adminGoodsOrder.shippingAddress == null : shippingAddress.equals(adminGoodsOrder.shippingAddress)) &&
        (remarks == null ? adminGoodsOrder.remarks == null : remarks.equals(adminGoodsOrder.remarks)) &&
        (goodsId == null ? adminGoodsOrder.goodsId == null : goodsId.equals(adminGoodsOrder.goodsId)) &&
        (statusFlowRecords == null ? adminGoodsOrder.statusFlowRecords == null : statusFlowRecords.equals(adminGoodsOrder.statusFlowRecords)) &&
        (usName == null ? adminGoodsOrder.usName == null : usName.equals(adminGoodsOrder.usName)) &&
        (usAvatar == null ? adminGoodsOrder.usAvatar == null : usAvatar.equals(adminGoodsOrder.usAvatar)) &&
        (usId == null ? adminGoodsOrder.usId == null : usId.equals(adminGoodsOrder.usId));
  }
  ...
  public String toString()  {
    ...
    sb.append("class AdminGoodsOrder {\n");
