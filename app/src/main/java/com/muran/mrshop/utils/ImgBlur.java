...
public class ImgBlur {
     ...
     * @param view
     * @param radius 模糊的半径
     * scaleFactory 缩放因子主要是为了优化算法加快速度
     * @param marginLeft
     * @param marginTop
     */
    @SuppressLint("NewApi")
    public static void blurViewBg(Context context, Bitmap bkg, View view, int radius, float scaleFactor,
        ...
        // 数据单位转换
        marginLeft = (int) (DeviceUtil.dp2px(context, marginLeft));
        marginTop = (int) (DeviceUtil.dp2px(context, marginTop));
        ...
        overlay = ImgBlur.fastBlur(overlay, (int) radius);
